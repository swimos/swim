...
final class MqttPingReqPacketEncoder extends Encoder<Object, MqttPingReqPacket> {
  ...
  public Encoder<Object, MqttPingReqPacket> pull(OutputBuffer<?> output) {
    return MqttPingReqPacketEncoder.encode(output, this.mqtt, this.packet,
                                           this.length, this.remaining, this.step);
  }

  static Encoder<Object, MqttPingReqPacket> encode(OutputBuffer<?> output, MqttEncoder mqtt,
                                                   MqttPingReqPacket packet, int length,
