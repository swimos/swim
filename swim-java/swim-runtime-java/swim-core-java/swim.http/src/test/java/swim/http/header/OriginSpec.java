...
public class OriginSpec {
  ...
  public void parseOriginHeaders() {
    assertParses("Origin: http://www.example.com",
                 Origin.create("http://www.example.com"));
    assertParses("Origin: https://www.example.com:443",
                 Origin.create("https://www.example.com:443"));
    assertParses("Origin: http://example1.com http://example2.com",
                 Origin.create("http://example1.com", "http://example2.com"));
    assertParses("Origin: http://example1.com:8080 http://example2.com:8081",
                 Origin.create("http://example1.com:8080", "http://example2.com:8081"));
    assertParses("Origin: null", Origin.empty());
  }

  @Test
  public void writeOriginHeaders() {
    assertWrites(Origin.create("http://www.example.com"),
                 "Origin: http://www.example.com");
    assertWrites(Origin.create("https://www.example.com:443"),
                 "Origin: https://www.example.com:443");
    assertWrites(Origin.create("http://example1.com", "http://example2.com"),
                 "Origin: http://example1.com http://example2.com");
    assertWrites(Origin.create("http://example1.com:8080", "http://example2.com:8081"),
