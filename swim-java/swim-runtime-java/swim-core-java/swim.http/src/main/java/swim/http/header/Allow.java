...
public final class Allow extends HttpHeader {
  ...
  public int hashCode() {
    ...
    return Murmur3.mash(Murmur3.mix(Allow.hashSeed, this.methods.hashCode()));
  }

  @Override
  public <T> Output<T> debug(Output<T> output) {
    output = output.write("Allow").write('.').write("create").write('(');
  ...
  public static Allow create(FingerTrieSeq<HttpMethod> methods) {
  ...
  public static Allow create(String... methodStrings) {
