...
public class WarpDownlinkPulse extends DownlinkPulse implements WarpPulse {
  ...
  public WarpDownlinkPulse(long linkCount, int eventRate, long eventCount,
  ...
  public Value toValue() {
    return WarpDownlinkPulse.form().mold(this).toValue();
  }

  private static Form<WarpDownlinkPulse> form;

  @Kind
  public static Form<WarpDownlinkPulse> form() {
    if (WarpDownlinkPulse.form == null) {
      WarpDownlinkPulse.form = new WarpDownlinkPulseForm();
    }
    return WarpDownlinkPulse.form;
  }

}

final class WarpDownlinkPulseForm extends Form<WarpDownlinkPulse> {

  @Override
  public Class<?> type() {
    return WarpDownlinkPulse.class;
  }

  @Override
  public Item mold(WarpDownlinkPulse pulse) {
    if (pulse != null) {
  ...
  @Override
  public WarpDownlinkPulse cast(Item item) {
    ...
    return new WarpDownlinkPulse(linkCount, eventRate, eventCount, commandRate, commandCount);
  }
