...
public class QTreeMapSpec {

  @Test(groups = {"benchmark"})
  public void benchmarkInserts() {
    final long duration = 5 * 1000L;
    final Random random = new Random();
    final QTreeMap<Long, Z2Shape, Object> tree = QTreeMap.empty(Z2Shape.shapeForm());
  ...
  public void benchmarkUpdates() {
    final int n = 500000;
    final QTreeMap<Integer, Z2Shape, Integer> tree = QTreeMap.empty(Z2Shape.shapeForm());
