...
public class HashGenCacheMap<K, V> {
    ...
    if (gen3Key != null && key.equals(gen3Key)) {
      ...
      if (gen3Val != null) {
        ...
        if (HashGenCacheMapBucket.GEN3_WEIGHT.incrementAndGet(bucket) > bucket.gen4Weight) {
          this.buckets.set(index, new HashGenCacheMapBucket<K, V>(bucket.gen3KeyRef, bucket.gen3ValRef, bucket.gen3Weight,
    ...
    if (gen2Key != null && key.equals(gen2Key)) {
      ...
      if (gen2Val != null) {
        ...
        if (HashGenCacheMapBucket.GEN2_WEIGHT.incrementAndGet(bucket) > bucket.gen3Weight) {
          this.buckets.set(index, new HashGenCacheMapBucket<K, V>(bucket.gen4KeyRef, bucket.gen4ValRef, bucket.gen4Weight,
                                                                 bucket.gen2KeyRef, bucket.gen2ValRef, bucket.gen2Weight,
  ...
  public V put(K key, V value) {
    ...
    if (gen4Key == null) {
      ...
      this.buckets.set(index, new HashGenCacheMapBucket<K, V>(bucket.gen4KeyRef, bucket.gen4ValRef, bucket.gen4Weight - 1,
  ...
  public boolean weaken(K key) {
    ...
    if (gen4Key != null && key.equals(gen4Key)) {
      final V gen4Val = bucket.gen4ValRef.get();
      if (gen4Val != null) {
        this.buckets.set(index, new HashGenCacheMapBucket<K, V>(HashGenCacheMap.weakRef(bucket.gen4KeyRef), HashGenCacheMap.weakRef(bucket.gen4ValRef), bucket.gen4Weight,
                                                               bucket.gen3KeyRef, bucket.gen3ValRef, bucket.gen3Weight,
                                                               bucket.gen2KeyRef, bucket.gen2ValRef, bucket.gen2Weight,
                                                               bucket.gen1KeyRef, bucket.gen1ValRef, bucket.gen1Weight));
        return true;
  ...
  static final AtomicLongFieldUpdater<HashGenCacheMap<?, ?>> GEN4_HITS =
      AtomicLongFieldUpdater.newUpdater((Class<HashGenCacheMap<?, ?>>) (Class<?>) HashGenCacheMap.class, "gen4Hits");
  @SuppressWarnings("unchecked")
  static final AtomicLongFieldUpdater<HashGenCacheMap<?, ?>> GEN3_HITS =
      AtomicLongFieldUpdater.newUpdater((Class<HashGenCacheMap<?, ?>>) (Class<?>) HashGenCacheMap.class, "gen3Hits");
  @SuppressWarnings("unchecked")
  static final AtomicLongFieldUpdater<HashGenCacheMap<?, ?>> GEN2_HITS =
      AtomicLongFieldUpdater.newUpdater((Class<HashGenCacheMap<?, ?>>) (Class<?>) HashGenCacheMap.class, "gen2Hits");
  @SuppressWarnings("unchecked")
  static final AtomicLongFieldUpdater<HashGenCacheMap<?, ?>> GEN1_HITS =
      AtomicLongFieldUpdater.newUpdater((Class<HashGenCacheMap<?, ?>>) (Class<?>) HashGenCacheMap.class, "gen1Hits");
  @SuppressWarnings("unchecked")
  static final AtomicLongFieldUpdater<HashGenCacheMap<?, ?>> MISSES =
      AtomicLongFieldUpdater.newUpdater((Class<HashGenCacheMap<?, ?>>) (Class<?>) HashGenCacheMap.class, "misses");

  static final SoftReference<Object> NULL_REF = new SoftReference<Object>(null);

  @SuppressWarnings("unchecked")
  static final <T> SoftReference<T> nullRef() {
    return (SoftReference<T>) HashGenCacheMap.NULL_REF;
  }
