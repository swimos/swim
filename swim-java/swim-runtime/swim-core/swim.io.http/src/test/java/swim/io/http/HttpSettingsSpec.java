...
public class HttpSettingsSpec {
  ...
  public void decodesStandardSettings() {
    assertCasts(Record.empty(), HttpSettings.standard());
  }

  @Test
  public void decodesStandardHttpSettings() {
    assertCasts(Record.of(Record.of(Attr.of("http"))), HttpSettings.standard());
  }

  @Test
  public void decodesHttpSettings() {
    assertCasts(Record.of(Record.of(Attr.of("http"),
  ...
  static void assertCasts(Value actualValue, HttpSettings expected) {
