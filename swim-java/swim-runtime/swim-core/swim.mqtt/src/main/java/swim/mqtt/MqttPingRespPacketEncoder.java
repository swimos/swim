...
final class MqttPingRespPacketEncoder extends Encoder<Object, MqttPingRespPacket> {
  ...
  public Encoder<Object, MqttPingRespPacket> pull(OutputBuffer<?> output) {
    return MqttPingRespPacketEncoder.encode(output, this.mqtt, this.packet,
                                            this.length, this.remaining, this.step);
  }

  static Encoder<Object, MqttPingRespPacket> encode(OutputBuffer<?> output, MqttEncoder mqtt,
                                                    MqttPingRespPacket packet, int length,
