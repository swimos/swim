...
final class MqttUnsubAckPacketEncoder extends Encoder<Object, MqttUnsubAckPacket> {
  ...
  public Encoder<Object, MqttUnsubAckPacket> pull(OutputBuffer<?> output) {
    return MqttUnsubAckPacketEncoder.encode(output, this.mqtt, this.packet,
                                            this.length, this.remaining, this.step);
  }

  static Encoder<Object, MqttUnsubAckPacket> encode(OutputBuffer<?> output, MqttEncoder mqtt,
                                                    MqttUnsubAckPacket packet, int length,
