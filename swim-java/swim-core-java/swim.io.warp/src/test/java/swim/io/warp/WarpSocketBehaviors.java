...
public abstract class WarpSocketBehaviors {
  protected abstract ServiceRef bind(HttpEndpoint endpoint, HttpService service);

  protected abstract SocketRef connect(HttpEndpoint endpoint, WarpSocket socket);
