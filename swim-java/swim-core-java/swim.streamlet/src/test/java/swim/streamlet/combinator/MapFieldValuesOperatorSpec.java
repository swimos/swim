...
public class MapFieldValuesOperatorSpec {
  ...
  public void evaluateMapFieldValuesOperatorAfterPut() {
    ...
    final MapFieldValuesOperator<String, Integer, Integer, Map<String, Integer>> square = new MapFieldValuesOperator<>() {
      @Override
  ...
  public void applyMapKeyOperatorAfterPut() {
    ...
    final MapValueOperator<Integer, Integer> square = new MapValueOperator<>() {
      @Override
