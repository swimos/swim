...
public class UriResolverSpec {
  ...
  public void testPathName() {
    assertEquals(Uri.parse("").pathName(), "");
    assertEquals(Uri.parse("foo").pathName(), "foo");
    assertEquals(Uri.parse("/foo").pathName(), "foo");
    assertEquals(Uri.parse("/foo/").pathName(), "");
    assertEquals(Uri.parse("/foo/bar").pathName(), "bar");
    assertEquals(Uri.parse("/foo/bar/").pathName(), "");
  }
