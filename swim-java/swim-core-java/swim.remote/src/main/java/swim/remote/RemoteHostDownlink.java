...
final class RemoteHostDownlink implements LinkBinding, PullRequest<Envelope> {
  ...
  RemoteHostDownlink(RemoteHost host, Uri remoteNodeUri, Uri nodeUri,
  ...
  static final AtomicIntegerFieldUpdater<RemoteHostDownlink> STATUS =
      AtomicIntegerFieldUpdater.newUpdater(RemoteHostDownlink.class, "status");
}
