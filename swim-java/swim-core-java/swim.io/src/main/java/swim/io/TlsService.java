...
class TlsService implements Transport, ServiceContext {
  ...
  TlsService(Station station, InetSocketAddress localAddress, ServerSocketChannel serverChannel,
  ...
  public void doAccept() throws IOException {
    ...
    final TlsSettings tlsSettings = this.socketSettings.tlsSettings();
    ...
    final TlsSocket transport = new TlsSocket(this.localAddress, remoteAddress, channel, sslEngine, this.socketSettings, false);
