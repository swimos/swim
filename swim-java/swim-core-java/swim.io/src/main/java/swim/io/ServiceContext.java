 ...
 * non-blocking NIO server socket channel.  A {@code ServiceContext} is
 * implicitly bound to a {@link Service}, providing the {@code Service} with
 * the ability to modify its {@link FlowControl} state, and to unbind the
 * network listener.
 */
