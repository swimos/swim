...
public abstract class ModemBehaviors {
  protected abstract ServiceRef bind(Endpoint endpoint, Service service);

  protected abstract SocketRef connect(Endpoint endpoint, Modem<?, ?> modem);

  @Test
  public void testConnection() {
    final Theater stage = new Theater();
    final Endpoint endpoint = new Endpoint(stage);
    ...
    final AbstractModem<Object, Object> client = new AbstractModem<Object, Object>() {
      @Override
      public void didConnect() {
        clientConnect.countDown();
      }
    };
    final AbstractModem<Object, Object> server = new AbstractModem<Object, Object>() {
      @Override
      public void didConnect() {
        serverConnect.countDown();
      }
    };
    final Service service = new AbstractService() {
      @Override
  ...
  public void testClientConnectError() {
    ...
    final AbstractModem<Object, Object> modem = new AbstractModem<Object, Object>() {
      @Override
  ...
  public void testClientCloseOnConnect() {
    ...
    final AbstractModem<String, String> client = new AbstractModem<String, String>() {
      @Override
      public void didConnect() {
        clientConnect.countDown();
        close();
    ...
    final AbstractModem<String, String> server = new AbstractModem<String, String>() {
      @Override
      public void didConnect() {
