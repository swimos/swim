...
@Internal
public final class WriteJsonString extends Write<Object> {
  ...
  public WriteJsonString(String string, int index, int escape, int step) {
    this.string = string;
    this.index = index;
    this.escape = escape;
    this.step = step;
  ...
  public Write<Object> produce(Output<?> output) {
    return WriteJsonString.write(output, this.string, this.index,
