...
final class JsonArrayParserMapper<E, B, S, T> implements JsonArrayParser<E, B, T>, WriteSource {
...
final class JsonDummyArrayParser<E, B, T> implements JsonArrayParser<E, B, T>, WriteSource {
