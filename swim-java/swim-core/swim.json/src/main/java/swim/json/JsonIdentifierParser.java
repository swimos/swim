...
final class JsonIdentifierParserMapper<S, T> implements JsonIdentifierParser<T>, ToSource {
...
final class JsonDummyIdentifierParser<T> implements JsonIdentifierParser<T>, ToSource {
