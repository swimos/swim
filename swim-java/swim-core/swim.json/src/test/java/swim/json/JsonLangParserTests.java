...
public class JsonLangParserTests {
  ...
  @JsonTypeInfo
  @JsonSubType(TestPoint2.class)
  @JsonSubType(TestPoint3.class)
  ...
  public static <T> void assertParses(JsonParser<T> parser, T expected, String json) {
    JsonAssertions.assertParses(parser.parse(), expected, json);
  }
  ...
  public static void assertParseFails(JsonParser<?> parser, final String json) {
    assertThrows(ParseException.class, () -> {
      parser.parse(json).checkDone();
    });
  }
