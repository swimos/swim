...
public class WsDeflateDecoderTests {
  ...
  public void inflateUnmaskedSharedWindow() {
    ...
    Decode<WsFrame<String>> frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C107F248CDC9C90700")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
    frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C105F200110000")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
    frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C10402130000")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
    frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C10402130000")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
  }
  ...
  public void inflateMaskedSharedWindow() {
    ...
    Decode<WsFrame<String>> frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C18737FA213DC5B2ECF4FEFD21")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
    frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C18537FA213DC5FA303D37")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
    frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C18437FA213D35E9213D")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
    frameDecoder = decoder.decodeMessage(new BinaryInputBuffer(Base16.parseByteBuffer("C18437FA213D35E9213D")).asLast(false), WsTestCodec.stringCodec());
    assertEquals(WsTextFrame.of("Hello"), frameDecoder.get());
  }
