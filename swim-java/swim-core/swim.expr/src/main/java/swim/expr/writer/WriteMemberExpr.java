...
@Internal
public final class WriteMemberExpr extends Write<Object> {
  ...
  public WriteMemberExpr(ExprWriter writer, TermForm<?> form, Term scope,
  ...
  public Write<Object> produce(Output<?> output) {
    return WriteMemberExpr.write(output, this.writer, this.form, this.scope,
  ...
  public static Write<Object> write(Output<?> output, ExprWriter writer,
    ...
    return new WriteMemberExpr(writer, form, scope, key,
