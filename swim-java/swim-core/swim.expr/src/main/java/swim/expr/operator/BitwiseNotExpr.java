...
@Public
@Since("5.0")
public final class BitwiseNotExpr extends PrefixExpr implements ToSource {

  public BitwiseNotExpr(Term rhs) {
    super(rhs);
  }
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof BitwiseNotExpr) {
      final BitwiseNotExpr that = (BitwiseNotExpr) other;
  ...
  public void writeSource(Appendable output) {
    ...
    notation.beginInvoke("BitwiseNotExpr", "of")
  ...
  public static BitwiseNotExpr of(Term rhs) {
    return new BitwiseNotExpr(rhs);
  }
