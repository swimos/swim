...
@Public
@Since("5.0")
public final class DivideExpr extends InfixExpr implements ToSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof DivideExpr) {
      final DivideExpr that = (DivideExpr) other;
      return this.lhs.equals(that.lhs) && this.rhs.equals(that.rhs);
    }
    return false;
  }

  private static final int hashSeed = Murmur3.seed(DivideExpr.class);

  @Override
  public int hashCode() {
    return Murmur3.mash(Murmur3.mix(Murmur3.mix(DivideExpr.hashSeed,
  ...
  public void writeSource(Appendable output) {
    ...
    notation.beginInvoke("DivideExpr", "of")
