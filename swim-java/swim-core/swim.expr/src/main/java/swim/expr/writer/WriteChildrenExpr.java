...
@Internal
public final class WriteChildrenExpr extends Write<Object> {
  ...
  public WriteChildrenExpr(ExprWriter writer, TermForm<?> form, Term scope,
  ...
  public Write<Object> produce(Output<?> output) {
    return WriteChildrenExpr.write(output, this.writer, this.form, this.scope,
  ...
  public static Write<Object> write(Output<?> output, ExprWriter writer,
    ...
    if (step == 1) {
      if (writer.isLiteralChildrenExpr(form, scope)) {
        step = 5;
    ...
    return new WriteChildrenExpr(writer, form, scope, precedence, write, step);
  }
