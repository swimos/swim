...
@Public
@Since("5.0")
public final class GeExpr extends InfixExpr implements ToSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof GeExpr) {
      final GeExpr that = (GeExpr) other;
      return this.lhs.equals(that.lhs) && this.rhs.equals(that.rhs);
    }
    return false;
  }

  private static final int hashSeed = Murmur3.seed(GeExpr.class);

  @Override
  public int hashCode() {
    return Murmur3.mash(Murmur3.mix(Murmur3.mix(GeExpr.hashSeed,
