...
public final class FilterTerm implements Term, ToSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof FilterTerm) {
      final FilterTerm that = (FilterTerm) other;
  ...
  private static final int hashSeed = Murmur3.seed(FilterTerm.class);

  @Override
  public int hashCode() {
    return Murmur3.mash(Murmur3.mix(Murmur3.mix(FilterTerm.hashSeed,
