...
@Public
@Since("5.0")
public final class FilterMethod implements Term, ToSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof FilterMethod) {
      final FilterMethod that = (FilterMethod) other;
      return this.scope.equals(that.scope);
    }
    return false;
  }

  private static final int hashSeed = Murmur3.seed(FilterMethod.class);

  @Override
  public int hashCode() {
    return Murmur3.mash(Murmur3.mix(FilterMethod.hashSeed, this.scope.hashCode()));
  }
