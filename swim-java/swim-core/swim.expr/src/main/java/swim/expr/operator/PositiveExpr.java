...
@Public
@Since("5.0")
public final class PositiveExpr extends PrefixExpr implements ToSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof PositiveExpr) {
      final PositiveExpr that = (PositiveExpr) other;
      return this.rhs.equals(that.rhs);
    }
    return false;
  }

  private static final int hashSeed = Murmur3.seed(PositiveExpr.class);

  @Override
  public int hashCode() {
    return Murmur3.mash(Murmur3.mix(PositiveExpr.hashSeed, this.rhs.hashCode()));
  }
