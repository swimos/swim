...
@Public
@Since("5.0")
public final class NeExpr extends InfixExpr implements ToSource {

  public NeExpr(Term lhs, Term rhs) {
    super(lhs, rhs);
  }
  ...
  public boolean equals(@Nullable Object other) {
    if (other instanceof NeExpr) {
      final NeExpr that = (NeExpr) other;
  ...
  public void writeSource(Appendable output) {
    ...
    notation.beginInvoke("NeExpr", "of")
  ...
  public static NeExpr of(Term lhs, Term rhs) {
    return new NeExpr(lhs, rhs);
  }
