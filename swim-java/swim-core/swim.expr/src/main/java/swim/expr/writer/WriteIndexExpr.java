...
@Internal
public final class WriteIndexExpr extends Write<Object> {
  ...
  public WriteIndexExpr(ExprWriter writer, TermForm<?> form, Term scope, int index,
  ...
  public Write<Object> produce(Output<?> output) {
    return WriteIndexExpr.write(output, this.writer, this.form, this.scope,
                                this.index, this.precedence, this.write,
                                this.step);
  }

  public static Write<Object> write(Output<?> output, ExprWriter writer,
                                    TermForm<?> form, Term scope, int index,
    ...
    return new WriteIndexExpr(writer, form, scope, index,
