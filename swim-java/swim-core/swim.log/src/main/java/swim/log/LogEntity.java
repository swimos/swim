...
/**
 * An object that can provide structured entity information
...
public interface LogEntity {
  ...
  /**
   * Returns the structured entity of this object for inclusion in log events
   * with the given severity {@code level}.
   */
  @Nullable Object toLogEntity(Severity level);

  /**
   * Returns the structured entity of the given {@code object} for inclusion
   * in log events with the given severity {@code level}. Delegates to
   * {@link #toLogEntity(Severity) object.toLogEntity(level)},
