...
@Public
@Since("5.0")
public final class GtExpr extends ComparisonExpr implements WriteSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (this == other) {
      return true;
    } else if (other instanceof GtExpr that) {
      return this.lhs.equals(that.lhs) && this.rhs.equals(that.rhs);
    }
    return false;
  }

  private static final int HASH_SEED = Murmur3.seed(GtExpr.class);
