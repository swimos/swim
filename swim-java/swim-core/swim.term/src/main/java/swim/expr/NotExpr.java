...
@Public
@Since("5.0")
public final class NotExpr extends PrefixExpr implements WriteSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (this == other) {
      return true;
    } else if (other instanceof NotExpr that) {
      return this.rhs.equals(that.rhs);
    }
    return false;
  }

  private static final int HASH_SEED = Murmur3.seed(NotExpr.class);
