...
public final class BooleanTerm implements Term, WriteSource {
  ...
  public boolean equals(@Nullable Object other) {
    if (this == other) {
      return true;
    } else if (other instanceof Term that && that.canEqual(this) && that.isValidBoolean()) {
      return this.value == that.booleanValue();
    }
    return false;
  }
  ...
  static final BooleanTerm FALSE = new BooleanTerm(false);
