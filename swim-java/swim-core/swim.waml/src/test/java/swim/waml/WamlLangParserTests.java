...
public class WamlLangParserTests {
  ...
  public static <T> void assertParses(WamlParser<T> parser, T expected, String waml) {
    WamlAssertions.assertParses(parser.parse(WamlParserOptions.standard()), expected, waml);
  }
  ...
  public static void assertParseFails(WamlParser<?> parser, final String waml) {
    assertThrows(ParseException.class, () -> {
      parser.parse(waml, WamlParserOptions.standard()).checkDone();
    });
  }
