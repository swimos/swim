...
public class WamlExprParserTests {
  ...
  public void parseAttributedIdentifiers() {
    assertParses(TermRepr.of(ContextExpr.child(Term.of("test"))).withAttr("hello"),
                 "@hello test");
    assertParses(TermRepr.of(ContextExpr.child(Term.of("test"))).withAttr("hello"),
                 "@hello() test");
    assertParses(TermRepr.of(ContextExpr.child(Term.of("test"))).withAttr("hello", Repr.of("world")),
                 "@hello(\"world\") test");
    assertParses(TermRepr.of(ContextExpr.child(Term.of("test"))).withAttr("hello", TupleRepr.of("name", Repr.of("world"))),
  ...
  public void parseExprsInMarkup() {
    assertParses(ArrayRepr.of(Repr.of("Hello, "), TermRepr.of(ContextExpr.child(Term.of("audience"))), Repr.of("!")),
                 "<<Hello, {audience}!>>");
  }
