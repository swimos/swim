...
final class WamlStringParserMapper<B, S, T> implements WamlStringParser<B, T>, ToSource {
...
final class WamlDummyStringParser<B, T> implements WamlStringParser<B, T>, ToSource {
