...
final class WamlArrayParserMapper<E, B, S, T> implements WamlArrayParser<E, B, T>, ToSource {
...
final class WamlDummyArrayParser<E, B, T> implements WamlArrayParser<E, B, T>, ToSource {
