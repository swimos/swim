...
final class WamlAttrsParserMapper<V, B, S, T> implements WamlAttrsParser<V, B, T>, ToSource {
...
final class WamlDummyAttrsParser<V, B, T> implements WamlAttrsParser<V, B, T>, ToSource {
