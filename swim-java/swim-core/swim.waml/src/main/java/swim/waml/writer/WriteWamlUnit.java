...
@Internal
public final class WriteWamlUnit extends Write<Object> {
  ...
  public WriteWamlUnit(WamlWriter writer, WamlForm<?> form,
  ...
  public Write<Object> produce(Output<?> output) {
    return WriteWamlUnit.write(output, this.writer, this.form,
                               this.attrs, this.write, this.step);
  }

  public static Write<Object> write(Output<?> output, WamlWriter writer, WamlForm<?> form,
                                    Iterator<? extends Map.Entry<String, ?>> attrs,
                                    @Nullable Write<?> write, int step) {
    do {
      if (step == 1) {
    ...
    return new WriteWamlUnit(writer, form, attrs, write, step);
  }
