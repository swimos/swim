...
@Internal
public abstract class UriAuthorityMapper<T> extends UriSchemeMapper<T> {
  ...
  abstract @Nullable T get(UriAuthority authority, UriPath path, UriQuery query, UriFragment fragment);
