...
public class HttpStatusTests {
  ...
  public void writeStatusesByCode() {
    assertWrites("100 Continue", HttpStatus.forCode(100));
    assertWrites("101 Switching Protocols", HttpStatus.forCode(101));
    assertWrites("200 OK", HttpStatus.forCode(200));
    assertWrites("201 Created", HttpStatus.forCode(201));
    assertWrites("202 Accepted", HttpStatus.forCode(202));
    assertWrites("203 Non-Authoritative Information", HttpStatus.forCode(203));
    assertWrites("204 No Content", HttpStatus.forCode(204));
    assertWrites("205 Reset Content", HttpStatus.forCode(205));
    assertWrites("206 Partial Content", HttpStatus.forCode(206));
    assertWrites("300 Multiple Choices", HttpStatus.forCode(300));
    assertWrites("301 Moved Permanently", HttpStatus.forCode(301));
    assertWrites("302 Found", HttpStatus.forCode(302));
    assertWrites("303 See Other", HttpStatus.forCode(303));
    assertWrites("304 Not Modified", HttpStatus.forCode(304));
    assertWrites("305 Use Proxy", HttpStatus.forCode(305));
    assertWrites("307 Temporary Redirect", HttpStatus.forCode(307));
    assertWrites("400 Bad Request", HttpStatus.forCode(400));
    assertWrites("401 Unauthorized", HttpStatus.forCode(401));
    assertWrites("402 Payment Required", HttpStatus.forCode(402));
    assertWrites("403 Forbidden", HttpStatus.forCode(403));
    assertWrites("404 Not Found", HttpStatus.forCode(404));
    assertWrites("405 Method Not Allowed", HttpStatus.forCode(405));
    assertWrites("406 Not Acceptable", HttpStatus.forCode(406));
    assertWrites("407 Proxy Authentication Required", HttpStatus.forCode(407));
    assertWrites("408 Request Timeout", HttpStatus.forCode(408));
    assertWrites("409 Conflict", HttpStatus.forCode(409));
    assertWrites("410 Gone", HttpStatus.forCode(410));
    assertWrites("411 Length Required", HttpStatus.forCode(411));
    assertWrites("412 Precondition Failed", HttpStatus.forCode(412));
    assertWrites("413 Payload Too Large", HttpStatus.forCode(413));
    assertWrites("414 URI Too Long", HttpStatus.forCode(414));
    assertWrites("415 Unsupported Media Type", HttpStatus.forCode(415));
    assertWrites("416 Range Not Satisfiable", HttpStatus.forCode(416));
    assertWrites("417 Expectation Failed", HttpStatus.forCode(417));
    assertWrites("426 Upgrade Required", HttpStatus.forCode(426));
    assertWrites("500 Internal Server Error", HttpStatus.forCode(500));
    assertWrites("501 Not Implemented", HttpStatus.forCode(501));
    assertWrites("502 Bad Gateway", HttpStatus.forCode(502));
    assertWrites("503 Service Unavailable", HttpStatus.forCode(503));
    assertWrites("504 Gateway Timeout", HttpStatus.forCode(504));
    assertWrites("505 HTTP Version Not Supported", HttpStatus.forCode(505));
  }
