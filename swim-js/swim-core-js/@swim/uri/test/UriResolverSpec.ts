...
export class UriResolverSpec extends Spec {
  ...
  testPathName(exam: Exam): void {
    exam.equal(Uri.parse("").pathName(), "");
    exam.equal(Uri.parse("foo").pathName(), "foo");
    exam.equal(Uri.parse("/foo").pathName(), "foo");
    exam.equal(Uri.parse("/foo/").pathName(), "");
    exam.equal(Uri.parse("/foo/bar").pathName(), "bar");
    exam.equal(Uri.parse("/foo/bar/").pathName(), "");
  }
