...
```sh
swim-js $ bin/build.js compile -p core:main,ui
```
...
```sh
swim-js $ bin/build.js test -p ui
```
...
```sh
swim-js $ bin/build.js watch -p vis:main
```
...
```sh
swim-js $ bin/build.js watch -p ui:test -d -t
```

### Building documentation

```sh
swim-js $ bin/build.js doc -p platform
```
