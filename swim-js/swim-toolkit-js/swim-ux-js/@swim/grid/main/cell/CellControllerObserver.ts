...
export interface CellControllerObserver<C extends CellController = CellController> extends ControllerObserver<C> {
  ...
  controllerWillSetCellContentView?(cellContentView: HtmlView | null, oldCellContentView: HtmlView | null, controller: C): void;

  controllerDidSetCellContentView?(cellContentView: HtmlView | null, oldCellContentView: HtmlView | null, controller: C): void;
}
