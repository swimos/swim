...
export interface ModelRelationFactory<F extends ModelRelation<any, any> = ModelRelation<any, any>> extends ModelRelationClass<F> {
  ...
  define<O, M extends Model = Model, I = {}>(className: string, descriptor: ModelRelationDescriptor<O, M, I>): ModelRelationFactory<ModelRelation<any, M> & I>;
  define<O, M extends Model = Model, I = {}>(className: string, descriptor: {observes: boolean} & ModelRelationDescriptor<O, M, I & ObserverType<M>>): ModelRelationFactory<ModelRelation<any, M> & I>;
  ...
  <O, M extends Model = Model, I = {}>(descriptor: ModelRelationDescriptor<O, M, I>): PropertyDecorator;
...
export const ModelRelation = (function (_super: typeof Fastener) {
  ...
  Object.defineProperty(ModelRelation.prototype, "familyType", {
    get: function (this: ModelRelation): Class<ModelRelation<any, any>> | null {
