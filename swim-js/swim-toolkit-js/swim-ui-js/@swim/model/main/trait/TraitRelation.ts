...
export interface TraitRelationFactory<F extends TraitRelation<any, any> = TraitRelation<any, any>> extends TraitRelationClass<F> {
  ...
  define<O, T extends Trait = Trait, I = {}>(className: string, descriptor: TraitRelationDescriptor<O, T, I>): TraitRelationFactory<TraitRelation<any, T> & I>;
  define<O, T extends Trait = Trait, I = {}>(className: string, descriptor: {observes: boolean} & TraitRelationDescriptor<O, T, I & ObserverType<T>>): TraitRelationFactory<TraitRelation<any, T> & I>;
  ...
  <O, T extends Trait = Trait, I = {}>(descriptor: TraitRelationDescriptor<O, T, I>): PropertyDecorator;
...
export const TraitRelation = (function (_super: typeof Fastener) {
  ...
  Object.defineProperty(TraitRelation.prototype, "familyType", {
    get: function (this: TraitRelation): Class<TraitRelation<any, any>> | null {
