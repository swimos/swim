...
export interface HistoryManagerObserver<C extends Controller = Controller, CM extends HistoryManager<C> = HistoryManager<C>> extends ControllerManagerObserver<C, CM> {
