...
export interface ControllerRelationFactory<F extends ControllerRelation<any, any> = ControllerRelation<any, any>> extends ControllerRelationClass<F> {
  ...
  define<O, C extends Controller = Controller, I = {}>(className: string, descriptor: ControllerRelationDescriptor<O, C, I>): ControllerRelationFactory<ControllerRelation<any, C> & I>;
  define<O, C extends Controller = Controller, I = {}>(className: string, descriptor: {observes: boolean} & ControllerRelationDescriptor<O, C, I & ObserverType<C>>): ControllerRelationFactory<ControllerRelation<any, C> & I>;
  ...
  <O, C extends Controller = Controller, I = {}>(descriptor: ControllerRelationDescriptor<O, C, I>): PropertyDecorator;
...
export const ControllerRelation = (function (_super: typeof Fastener) {
  ...
  Object.defineProperty(ControllerRelation.prototype, "familyType", {
    get: function (this: ControllerRelation): Class<ControllerRelation<any, any>> | null {
