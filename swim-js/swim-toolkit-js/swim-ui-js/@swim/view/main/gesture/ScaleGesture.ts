...
import {GestureMethod, Gesture} from "./Gesture";
...
export interface ScaleGestureInit<V extends View, X, Y> extends MomentumGestureInit<V> {
  extends?: ScaleGestureClass;
...
export type ScaleGestureDescriptor<G extends GestureContext, V extends View, X, Y, I = {}> = ScaleGestureInit<V, X, Y> & ThisType<ScaleGesture<G, V, X, Y> & I> & Partial<I>;

export interface ScaleGestureConstructor<G extends GestureContext, V extends View, X, Y, I = {}> {
  new<O extends G>(owner: O, gestureName: string | undefined): ScaleGesture<O, V, X, Y> & I;
  prototype: ScaleGesture<any, any, any, any> & I;
}

export interface ScaleGestureClass extends Function {
  readonly prototype: ScaleGesture<any, any, any, any>;
}

export interface ScaleGesture<G extends GestureContext, V extends View, X, Y> extends MomentumGesture<G, V> {
...
export const ScaleGesture = function <G extends GestureContext, V extends View, X, Y>(
    this: ScaleGesture<G, V, X, Y> | typeof ScaleGesture,
    owner: G | ScaleGestureDescriptor<G, V, X, Y>,
    gestureName?: string,
  ): ScaleGesture<G, V, X, Y> | PropertyDecorator {
  if (this instanceof ScaleGesture) { // constructor
    return ScaleGestureConstructor.call(this as unknown as ScaleGesture<GestureContext, View, unknown, unknown>, owner as G, gestureName);
  } else { // decorator factory
    return ScaleGestureDecoratorFactory(owner as ScaleGestureDescriptor<G, V, X, Y>);
  }
} as {
  /** @hidden */
  new<G extends GestureContext, V extends View, X, Y>(owner: G, gestureName: string | undefined): ScaleGesture<G, V, X, Y>;

  <G extends GestureContext, V extends View = View, X = unknown, Y = unknown, I = {}>(descriptor: {observe: boolean} & ScaleGestureDescriptor<G, V, X, Y, I & ViewObserverType<V>>): PropertyDecorator;
  <G extends GestureContext, V extends View = View, X = unknown, Y = unknown, I = {}>(descriptor: ScaleGestureDescriptor<G, V, X, Y, I>): PropertyDecorator;

  /** @hidden */
  prototype: ScaleGesture<any, any, any, any>;

  /** @hidden */
  getClass(method: GestureMethod): ScaleGestureClass;

  define<G extends GestureContext, V extends View = View, X = unknown, Y = unknown, I = {}>(descriptor: {observe: boolean} & ScaleGestureDescriptor<G, V, X, Y, I & ViewObserverType<V>>): ScaleGestureConstructor<G, V, X, Y, I>;
  define<G extends GestureContext, V extends View = View, X = unknown, Y = unknown, I = {}>(descriptor: ScaleGestureDescriptor<G, V, X, Y, I>): ScaleGestureConstructor<G, V, X, Y, I>;

  /** @hidden */
  distanceMin: number;
};
__extends(ScaleGesture, MomentumGesture);
...
function ScaleGestureDecoratorFactory<G extends GestureContext, V extends View, X, Y>(descriptor: ScaleGestureDescriptor<G, V, X, Y>): PropertyDecorator {
  return GestureContext.decorateGesture.bind(View, ScaleGesture.define(descriptor as ScaleGestureDescriptor<GestureContext, View, unknown, unknown>));
}

Object.defineProperty(ScaleGesture.prototype, "observe", {
  value: true,
  enumerable: true,
  configurable: true,
});

ScaleGesture.prototype.createInput = function (this: ScaleGesture<GestureContext, View, unknown, unknown>, inputId: string, inputType: GestureInputType, isPrimary: boolean,
                                               x: number, y: number, t: number): ScaleGestureInput<unknown, unknown> {
  return new ScaleGestureInput(inputId, inputType, isPrimary, x, y, t);
};

ScaleGesture.prototype.clearInputs = function (this: ScaleGesture<GestureContext, View, unknown, unknown>): void {
  MomentumGesture.prototype.clearInputs.call(this);
  this.setGestureFlags(this.gestureFlags & ~Gesture.NeedsRescale);
};

Object.defineProperty(ScaleGesture.prototype, "preserveAspectRatio", {
  get(this: ScaleGesture<GestureContext, View, unknown, unknown>): boolean {
    return (this.gestureFlags & Gesture.PreserveAspectRatioFlag) !== 0;
  },
  set(this: ScaleGesture<GestureContext, View, unknown, unknown>, preserveAspectRatio: boolean): void {
    if (preserveAspectRatio) {
      this.setGestureFlags(this.gestureFlags | Gesture.PreserveAspectRatioFlag);
    } else {
      this.setGestureFlags(this.gestureFlags & ~Gesture.PreserveAspectRatioFlag);
    }
  },
...
Object.defineProperty(ScaleGesture.prototype, "wheel", {
  get(this: ScaleGesture<GestureContext, View, unknown, unknown>): boolean {
    return (this.gestureFlags & Gesture.WheelFlag) !== 0;
  },
  set(this: ScaleGesture<GestureContext, View, unknown, unknown>, wheel: boolean): void {
    if (wheel) {
...
ScaleGesture.prototype.getXScale = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>): ContinuousScale<X, number> | null {
  return null; // hook
};

ScaleGesture.prototype.setXScale = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, xScale: ContinuousScale<X, number> | null, timing?: AnyTiming | boolean): void {
  // hook
};

ScaleGesture.prototype.getYScale = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>): ContinuousScale<Y, number> | null {
  return null; // hook
};

ScaleGesture.prototype.setYScale = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, yScale: ContinuousScale<Y, number> | null, timing?: AnyTiming | boolean): void {
  // hook
};

ScaleGesture.prototype.clientToRangeX = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, clientX: number, xScale: ContinuousScale<X, number>, bounds: R2Box): number {
...
ScaleGesture.prototype.clientToRangeY = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, clientY: number, yScale: ContinuousScale<Y, number>, bounds: R2Box): number {
...
ScaleGesture.prototype.unscaleX = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, clientX: number, xScale: ContinuousScale<X, number>, bounds: R2Box): X {
  return xScale.inverse(this.clientToRangeX(clientX, xScale, bounds));
};

ScaleGesture.prototype.unscaleY = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, clientY: number, yScale: ContinuousScale<Y, number>, bounds: R2Box): Y {
  return yScale.inverse(this.clientToRangeY(clientY, yScale, bounds));
};

ScaleGesture.prototype.viewWillAnimate = function (this: ScaleGesture<GestureContext, View, unknown, unknown>, viewContext: ViewContext): void {
  MomentumGesture.prototype.viewWillAnimate.call(this, viewContext);
  if ((this.gestureFlags & Gesture.NeedsRescale) !== 0) {
    this.rescale();
  }
};

ScaleGesture.prototype.onBeginPress = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
...
ScaleGesture.prototype.onMovePress = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
  MomentumGesture.prototype.onMovePress.call(this, input, event);
  this.view!.requireUpdate(View.NeedsAnimate);
  this.setGestureFlags(this.gestureFlags | Gesture.NeedsRescale);
};

ScaleGesture.prototype.onEndPress = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
...
ScaleGesture.prototype.onCancelPress = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
...
ScaleGesture.prototype.beginCoast = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
  if (this.coastCount < 2) {
    MomentumGesture.prototype.beginCoast.call(this, input, event);
  }
};

ScaleGesture.prototype.onBeginCoast = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
...
ScaleGesture.prototype.onEndCoast = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input: ScaleGestureInput<X, Y>, event: Event | null): void {
...
ScaleGesture.prototype.onCoast = function (this: ScaleGesture<GestureContext, View, unknown, unknown>): void {
  MomentumGesture.prototype.onCoast.call(this);
  this.view!.requireUpdate(View.NeedsAnimate);
  this.setGestureFlags(this.gestureFlags | Gesture.NeedsRescale);
};

ScaleGesture.prototype.updateInputDomain = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
...
ScaleGesture.prototype.neutralizeX = function (this: ScaleGesture<GestureContext, View, unknown, unknown>): void {
...
ScaleGesture.prototype.neutralizeY = function (this: ScaleGesture<GestureContext, View, unknown, unknown>): void {
  const inputs = this.inputs;
  for (const inputId in inputs) {
    const input = inputs[inputId]!;
    if (input.coasting) {
...
ScaleGesture.prototype.rescale = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>): void {
...
ScaleGesture.prototype.rescaleRadial = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
...
ScaleGesture.prototype.rescaleXY = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
                                                   oldXScale: ContinuousScale<X, number>,
                                                   oldYScale: ContinuousScale<Y, number>,
                                                   input0: ScaleGestureInput<X, Y>,
                                                   input1: ScaleGestureInput<X, Y> | undefined,
...
ScaleGesture.prototype.rescaleX = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
                                                  oldXScale: ContinuousScale<X, number>,
                                                  input0: ScaleGestureInput<X, Y>,
                                                  input1: ScaleGestureInput<X, Y> | undefined,
                                                  bounds: R2Box): void {
...
ScaleGesture.prototype.rescaleY = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
                                                  oldYScale: ContinuousScale<Y, number>,
                                                  input0: ScaleGestureInput<X, Y>,
                                                  input1: ScaleGestureInput<X, Y> | undefined,
                                                  bounds: R2Box): void {
...
ScaleGesture.prototype.conserveMomentum = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, input0: ScaleGestureInput<X, Y>): void {
  let input1: ScaleGestureInput<X, Y> | undefined;
  const inputs = this.inputs;
  for (const inputId in inputs) {
    const input = inputs[inputId]!;
...
ScaleGesture.prototype.distributeXYMomentum = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
                                                              input0: ScaleGestureInput<X, Y>,
                                                              input1: ScaleGestureInput<X, Y>): void {
  const vx0 = input0.vx;
  const vy0 = input0.vy;
...
ScaleGesture.prototype.distributeXMomentum = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
                                                             input0: ScaleGestureInput<X, Y>,
                                                             input1: ScaleGestureInput<X, Y>): void {
  const vx0 = input0.vx;
  const vx1 = input1.vx;
...
ScaleGesture.prototype.distributeYMomentum = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>,
                                                             input0: ScaleGestureInput<X, Y>,
                                                             input1: ScaleGestureInput<X, Y>): void {
  const vy0 = input0.vy;
  const vy1 = input1.vy;
...
ScaleGesture.prototype.integrate = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, t: number): void {
...
ScaleGesture.prototype.zoom = function <X, Y>(this: ScaleGesture<GestureContext, View, X, Y>, x: number, y: number, dz: number, event: Event | null): void {
  if (dz === 0) {
    return;
  }
...
ScaleGesture.getClass = function (method: GestureMethod): ScaleGestureClass {
  if (method === "pointer") {
...
ScaleGesture.define = function <G extends GestureContext, V extends View, X, Y, I>(descriptor: ScaleGestureDescriptor<G, V, X, Y, I>): ScaleGestureConstructor<G, V, X, Y, I> {
  let _super: ScaleGestureClass | null | undefined = descriptor.extends;
  ...
  if (_super === void 0) {
    _super = ScaleGesture.getClass(method);
  }

  const _constructor = function DecoratedScaleGesture(this: ScaleGesture<G, V, X, Y>, owner: G, gestureName: string | undefined): ScaleGesture<G, V, X, Y> {
    let _this: ScaleGesture<G, V, X, Y> = function ScaleGestureAccessor(view?: V | null, targetView?: View | null): V | null | G {
      if (view === void 0) {
        return _this.view;
      } else {
  ...
  const _prototype = descriptor as unknown as ScaleGesture<any, any, any, any> & I;
