...
import {StructureInterpolatorSpec} from "./StructureInterpolatorSpec";
...
class InterpolatorSpec extends Spec {
  ...
  @Unit
  structureInterpolatorSpec(): Spec {
    return new StructureInterpolatorSpec();
  }
}

export {
  NumberInterpolatorSpec,
  StructureInterpolatorSpec,
  InterpolatorSpec,
};
