...
import {AnyItem, Field, Slot, Value} from "@swim/structure";
import {Interpolator} from "../Interpolator";
import {StructureInterpolator} from "../StructureInterpolator";

export class SlotInterpolator extends StructureInterpolator<Slot> {
  private readonly keyInterpolator: StructureInterpolator<Value>;
