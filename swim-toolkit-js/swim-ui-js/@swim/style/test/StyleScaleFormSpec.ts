...
export class StyleScaleFormSpec extends Spec {
  @Test
  moldLinearScales(exam: Exam): void {
    exam.equal(StyleValue.scaleForm().mold(Scale.linear(5, 11, 13, 17)),
  ...
  castLinearScales(exam: Exam): void {
    exam.equal(Record.of(Attr.of("scale", Record.of(5, 11)),
                         Attr.of("interpolate", Record.of(13, 17))),
                StyleValue.scaleForm().mold(Scale.linear(5, 11, 13, 17)));
  }

  @Test
  moldTimeScales(exam: Exam): void {
    exam.equal(StyleValue.scaleForm().mold(Scale.time("2017-02-21T00:00:00.000Z", "2017-02-22T00:00:00.000Z", 13, 17)),
  ...
  castTimeScales(exam: Exam): void {
    exam.equal(Record.of(Attr.of("scale", Record.of("2017-02-21T00:00:00.000Z", "2017-02-22T00:00:00.000Z")),
                         Attr.of("interpolate", Record.of(13, 17))),
               StyleValue.scaleForm().mold(Scale.time("2017-02-21T00:00:00.000Z", "2017-02-22T00:00:00.000Z", 13, 17)));
  }
}
