...
export class GeoRasterView extends GeoLayerView {
  ...
  initView(init: GeoRasterViewInit): void {
    super.initView(init);
  ...
  static readonly mountFlags: ViewFlags = GeoLayerView.mountFlags | View.NeedsRender | View.NeedsComposite;
  static readonly powerFlags: ViewFlags = GeoLayerView.powerFlags | View.NeedsRender | View.NeedsComposite;
  static readonly uncullFlags: ViewFlags = GeoLayerView.uncullFlags | View.NeedsRender | View.NeedsComposite;
}
