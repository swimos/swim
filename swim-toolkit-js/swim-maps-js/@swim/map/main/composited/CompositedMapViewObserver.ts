...
import {CompositedViewObserver} from "@swim/view";
...
export interface CompositedMapViewObserver<V extends CompositedMapView = CompositedMapView> extends CompositedViewObserver<V>, MapViewObserver<V> {
