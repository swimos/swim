...
import {GeoViewController} from "../geo/GeoViewController";
import type {MapView} from "./MapView";
import type {MapViewObserver} from "./MapViewObserver";

export class MapViewController<V extends MapView = MapView> extends GeoViewController<V> implements MapViewObserver<V> {
