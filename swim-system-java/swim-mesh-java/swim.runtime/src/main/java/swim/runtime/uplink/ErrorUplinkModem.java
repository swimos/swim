...
public class ErrorUplinkModem implements LinkContext {
  ...
  static final AtomicIntegerFieldUpdater<ErrorUplinkModem> STATUS =
      AtomicIntegerFieldUpdater.newUpdater(ErrorUplinkModem.class, "status");
}
