...
public final class ProtobufStructure {
  ...
  public static ProtobufFieldType<Record, Value> field(Value key, long fieldNumber,
                                                       ProtobufType<? extends Value> valueType) {
    return new FieldStructure(key, fieldNumber, valueType);
  }

  public static ProtobufFieldType<Record, Value> field(String key, long fieldNumber,
                                                       ProtobufType<? extends Value> valueType) {
