...
final class ArrayReflection<I> extends ProtobufRepeatedType<I, Object> {

  final Class<?> itemClass;
  final ProtobufType<I> itemType;

  ArrayReflection(Class<?> itemClass, ProtobufType<I> itemType) {
  ...
  @Override
  public Builder<I, Object> valueBuilder() {
    return new ArrayReflectionBuilder<I>(this.itemClass);
  }

  @Override
  public Object appended(Object array, I item) {
    final int n = array != null ? Array.getLength(array) : 0;
    final Object newArray = Array.newInstance(this.itemClass, n + 1);
    if (array != null) {
