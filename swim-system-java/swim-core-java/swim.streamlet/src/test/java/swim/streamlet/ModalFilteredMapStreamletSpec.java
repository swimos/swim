...
public class ModalFilteredMapStreamletSpec extends ConnectorTest {
  ...
  public void changeFilterByMode(final boolean withState) {
    ...
    if (withState) {
      ...
      final ModalFilteredMapStreamlet<Integer, Integer, Parity> modalFilter = new ModalFilteredMapStreamlet<>(
          modePersister,
      ...
      final ModalFilteredMapStreamlet<Integer, Integer, Parity> modalFilter = new ModalFilteredMapStreamlet<>(Parity.ODD,
  ...
  private void changeFilterByMode(final ModalFilteredMapStreamlet<Integer, Integer, Parity> modalFilter) {
  ...
  private void retroactivelyRemoveInvalidEntries(final ModalFilteredMapStreamlet<Integer, Integer, Parity> modalFilter) {
    final ConnectorUtilities.ActionAccumulator<Integer, Integer> acc =
        new ConnectorUtilities.ActionAccumulator<>();
  ...
  private void retroactivelyRestoreValidKeys(final ModalFilteredMapStreamlet<Integer, Integer, Parity> modalFilter) {
    final ConnectorUtilities.ActionAccumulator<Integer, Integer> acc =
        new ConnectorUtilities.ActionAccumulator<>();
