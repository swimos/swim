...
public class SamplingMapConduitSpec extends ConnectorTest {
  ...
  private void sampleFromOutput(final FakeSchedule schedule, final SamplingMapConduit<String, Integer> conduit) {
