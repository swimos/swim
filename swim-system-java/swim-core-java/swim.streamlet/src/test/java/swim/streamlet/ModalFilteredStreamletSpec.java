...
public class ModalFilteredStreamletSpec {

  @Test
  public void filterByMode() {
    final ModalFilteredStreamlet<Integer, Parity> streamlet = new ModalFilteredStreamlet<>(
        Parity.EVEN, parity -> n -> n % 2 == parity.ordinal());

    final ArrayList<Integer> results = ConnectorUtilities.pushData(
        streamlet, Either.left(2), Either.left(7), Either.right(Parity.ODD), Either.left(2), Either.left(13));
