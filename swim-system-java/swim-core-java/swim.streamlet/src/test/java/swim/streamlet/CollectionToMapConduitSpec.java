...
public class CollectionToMapConduitSpec extends ConnectorTest {
  ...
  private void alterExistingEntry(final CollectionToMapConduit<Pair<Integer, String>, List<Pair<Integer, String>>, Integer, String> conduit) {
    ConnectorUtilities.pushData(
        conduit, Arrays.asList(Pair.pair(1, "a"), Pair.pair(2, "b"), Pair.pair(3, "c")));

    final ArrayList<MapAction<Integer, String>> results = ConnectorUtilities.pushData(
        conduit, Arrays.asList(Pair.pair(1, "a"), Pair.pair(2, "NEW!"), Pair.pair(3, "c")));
