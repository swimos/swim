...
public class ModalKeyFilterConduitSpec extends ConnectorTest {
  ...
  private void filterOutInputData(final ModalKeyFilterConduit<Integer, String, Parity> conduit) {
    ...
    final ArrayList<ConnectorUtilities.MapAction<Integer, String>> results =
        ConnectorUtilities.pushData(conduit, Either.left(acc.update(2, "a")));
    ...
    final ArrayList<ConnectorUtilities.MapAction<Integer, String>> results2 =
        ConnectorUtilities.pushData(conduit, Either.left(acc.update(1, "aaa")));
  ...
  private void retroactivelyRemoveInvalidKeys(final ModalKeyFilterConduit<Integer, String, Integer> conduit) {
    ...
    final ArrayList<ConnectorUtilities.MapAction<Integer, String>> results =
        ConnectorUtilities.pushData(conduit, Either.right(2));
