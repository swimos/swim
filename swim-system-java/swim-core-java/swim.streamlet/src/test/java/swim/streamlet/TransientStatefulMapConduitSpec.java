...
public class TransientStatefulMapConduitSpec extends ConnectorTest {
  ...
  public void foldInputsModally() {
    final TransientModalStatefulMapConduit<String, Integer, Parity, FingerTrieSeq<Integer>> conduit =
        StatefulConduits.modalFoldMap(Parity.ODD, FingerTrieSeq.empty(),
  ...
  public void reduceInputsModally() {
    final TransientModalStatefulMapConduit<String, Integer, Multiple, Integer> conduit =
        StatefulConduits.modalReduceMap(Multiple.DOUBLE, m -> (sum, n) -> sum * m.getFactor() + n);
