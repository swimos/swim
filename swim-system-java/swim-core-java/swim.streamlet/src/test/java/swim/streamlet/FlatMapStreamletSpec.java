...
public class FlatMapStreamletSpec extends ConnectorTest {

  @Test
  public void emitOutputsOnSchedule() {
    final FakeSchedule schedule = new FakeSchedule();

    final FlatMapStreamlet<Integer, Integer> streamlet = new FlatMapStreamlet<>(
        n -> Arrays.asList(n, n + 1, n + 2, n + 3),
    ...
    streamlet.notifyChange(Deferred.value(1));
