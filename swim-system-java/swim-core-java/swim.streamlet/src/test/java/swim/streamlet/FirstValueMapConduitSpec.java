...
public class FirstValueMapConduitSpec extends ConnectorTest {
  ...
  public void doesNotEmitValuesAfterFirstForAKey(final boolean resetOnRemoval) {
    ...
    final ArrayList<MapAction<String, Integer>> results2 = ConnectorUtilities.pushData(conduit, update("a", 5));
  ...
  public void remembersValuesForPastKeys(final boolean resetOnRemoval) {
    ...
    final ArrayList<MapAction<String, Integer>> results2 = ConnectorUtilities.pushData(conduit, update("b", 7));
  ...
  public void ignoresRemovalsInNoResetMode() {
    ...
    final ArrayList<MapAction<String, Integer>> results2 = ConnectorUtilities.pushData(conduit, remove("a"));

    Assert.assertTrue(results2.isEmpty());

    final ArrayList<MapAction<String, Integer>> results3 = ConnectorUtilities.pushData(conduit, update("a", 5));

    Assert.assertTrue(results3.isEmpty());

    final ArrayList<MapAction<String, Integer>> results4 = ConnectorUtilities.pushData(conduit, update("b", 7));
  ...
  public void removesFirstValueInResetMode() {
    ...
    final ArrayList<MapAction<String, Integer>> results3 = ConnectorUtilities.pushData(conduit, update("b", 7));
    ...
    final ArrayList<MapAction<String, Integer>> results4 = ConnectorUtilities.pushData(conduit, update("a", 5));
  ...
  public void restoresFromState(final boolean resetOnRemoval) {
    ...
    final ArrayList<MapAction<String, Integer>> results1 = ConnectorUtilities.pushData(conduit, update("a", 5));
