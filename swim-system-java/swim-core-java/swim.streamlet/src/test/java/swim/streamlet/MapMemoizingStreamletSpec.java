...
public class MapMemoizingStreamletSpec extends ConnectorTest {

  @Test
  public void singleComputationOfAllValues() {
    final MapMemoizingStreamlet<Integer, String> streamlet = new MapMemoizingStreamlet<>();
    ...
    streamlet.notifyChange(1, val1, Deferred.value(MapView.wrap(map)));
    streamlet.notifyChange(2, val2, Deferred.value(MapView.wrap(map.updated(2, val2))));
