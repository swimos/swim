...
public class TransientStatefulConduitSpec {
  ...
  public void foldInputs() {
    ...
    final ArrayList<FingerTrieSeq<Integer>> results = ConnectorUtilities.pushData(conduit, 1, 2, 3, 4);
  ...
  public void reduceInputs() {
    ...
    final ArrayList<Integer> results = ConnectorUtilities.pushData(conduit, 35, 76, 12, 7);
    Assert.assertEquals(results.size(), 4);
  ...
  public void foldInputsModally() {
    ...
    final ArrayList<FingerTrieSeq<Integer>> results = ConnectorUtilities.pushData(
        conduit, Either.left(1), Either.left(2), Either.right(Parity.EVEN), Either.left(3), Either.left(4));
  ...
  public void reduceInputsModally() {
    ...
    final ArrayList<Integer> results = ConnectorUtilities.pushData(
        conduit, Either.left(1), Either.left(2), Either.right(Multiple.TRIPLE), Either.left(3), Either.left(4));
