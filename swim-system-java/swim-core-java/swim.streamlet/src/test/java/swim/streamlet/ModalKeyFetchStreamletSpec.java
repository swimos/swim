...
public class ModalKeyFetchStreamletSpec {
  ...
  public void selectNothingInitially(final boolean withState) {
    if (withState) {
      ...
      final ModalKeyFetchStreamlet<Integer, String> selector = new ModalKeyFetchStreamlet<>(modePersister);

      selectNothingInitially(selector);

      Assert.assertNull(modePersister.get());
    } else {
      final ModalKeyFetchStreamlet<Integer, String> selector = new ModalKeyFetchStreamlet<>();

      selectNothingInitially(selector);
    }
  }

  private void selectNothingInitially(final ModalKeyFetchStreamlet<Integer, String> selector) {
  ...
  private void outputForSelectedKey(final ModalKeyFetchStreamlet<Integer, String> selector) {
    final ArrayList<String> results = new ArrayList<>();
  ...
  private void alterSelectedKey(final ModalKeyFetchStreamlet<Integer, String> selector) {
    final ArrayList<String> results = new ArrayList<>();
