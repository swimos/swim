...
public class ReduceFieldsConduitSpec {
  ...
  public void addValuesToReduction() {
    ...
    final ArrayList<Integer> outputs = ConnectorUtilities.pushData(conduit,
        acc.update(1000L, 5),
        acc.update(2000L, 7));
  ...
  public void replaceValueInReduction() {
    ...
    final ArrayList<Integer> outputs = ConnectorUtilities.pushData(conduit, acc.update(1000L, -3));
  ...
  public void removeValueFromReduction() {
    ...
    final ArrayList<Integer> outputs = ConnectorUtilities.pushData(conduit, acc.remove(1000L));
