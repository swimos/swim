...
public class FirstValueConduitSpec {
  ...
  public void emitsTheFirstValue() {
    ...
    final ArrayList<Integer> results = ConnectorUtilities.pushData(conduit, 2);
  ...
  public void doesNotEmitValuesAfterFirst() {
    ...
    final ArrayList<Integer> results2 = ConnectorUtilities.pushData(conduit, 5, 6);
  ...
  public void restoresFromState() {
    ...
    final ArrayList<Integer> results = ConnectorUtilities.pushData(conduit, 6, 4, 5);
