...
public class StatefulMapStreamletSpec extends ConnectorTest {
  ...
  public void foldInputs() {
    ...
    final MapStreamlet<String, String, Integer, FingerTrieSeq<Integer>> streamlet = StatefulStreamlets.foldMapPersistent(
  ...
  public void reduceInputs() {
    ...
    final StatefulMapStreamlet<String, Integer, Integer> streamlet = StatefulStreamlets.reduceMap(persister, Math::min);
  ...
  public void foldInputsModally() {
    ...
    final ModalStatefulMapStreamlet<String, Integer, Parity, FingerTrieSeq<Integer>> streamlet =
        StatefulStreamlets.modalFoldMap(modePersister, persister,
  ...
  public void reduceInputsModally() {
    ...
    final ModalStatefulMapStreamlet<String, Integer, Multiple, Integer> streamlet =
        StatefulStreamlets.modalReduceMap(modePersister, persister, m -> (sum, n) -> sum * m.getFactor() + n);
