...
/**
 * {@link Streamlet} that transforms the entries of a map using a function that produces a sequence of key values pairs
 ...
 */
public class FlatMapEntriesStreamlet<K1, K2, V1, V2> extends AbstractMapJunction<K2, V2> implements MapStreamlet<K1, K2, V1, V2> {
   ...
   *                 the input.
   */
  public FlatMapEntriesStreamlet(final BiFunction<K1, V1, Iterable<Pair<K2, V2>>> onUpdate,
