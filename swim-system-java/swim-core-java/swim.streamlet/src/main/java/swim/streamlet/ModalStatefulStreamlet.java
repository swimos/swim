...
/**
 * Streamlet that maintains an external state where the function that updates the state can be modified by an auxiliary
 * control input.
 *
 ...
 */
public class ModalStatefulStreamlet<In, Mode, State>
    extends ModalStreamlet<In, State, Mode, BiFunction<State, In, State>> {
   ...
   */
  public ModalStatefulStreamlet(final ValuePersister<Mode> modePersister,
