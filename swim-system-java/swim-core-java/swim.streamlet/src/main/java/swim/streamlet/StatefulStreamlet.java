...
/**
 * {@link Streamlet} that maintains an external state.
 *
 * @param <In>    The input type.
 * @param <State> The state type.
 */
public class StatefulStreamlet<In, State> extends AbstractJunction<State> implements Streamlet<In, State> {
   ...
   */
  public StatefulStreamlet(final ValuePersister<State> state,
