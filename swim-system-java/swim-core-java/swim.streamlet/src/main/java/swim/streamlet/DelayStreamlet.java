 ...
 */
public class DelayStreamlet<T> extends AbstractJunction<T> implements Streamlet<T, T> {
   ...
   */
  public DelayStreamlet(final ListPersister<T> persister, final int step) {
   ...
   * @param step Number of samples of delay.
   */
  public DelayStreamlet(final int step) {
