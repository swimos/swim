...
/**
 * Streamlet that maintains an internal state where the function that updates the state can be modified by an auxiliary
 * control input.
 *
 ...
 */
public final class TransientModalStatefulStreamlet<In, Mode, State>
    extends ModalStreamlet<In, State, Mode, BiFunction<Deferred<State>, Deferred<In>, Deferred<State>>> {
   ...
   */
  public TransientModalStatefulStreamlet(final Mode initMode,
