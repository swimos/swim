 ...
 */
public class ReduceFieldsStreamlet<Key, Value, Out> extends AbstractJunction<Out> implements MapToValueStreamlet<Key, Value, Out> {
   ...
   */
  public ReduceFieldsStreamlet(final Out seed,
