...
/**
 * Streamlet that buffers the values it receives and emits the values a fixed number of samples previous to the
 * most recently received value, for each key.
 *
 * @param <K> The type of the keys.
 * @param <V> The type of the values.
 */
public class DelayMapStreamlet<K, V> extends AbstractMapJunction<K, V> implements MapStreamlet<K, K, V, V> {
   ...
   */
  public DelayMapStreamlet(final Function<K, ListPersister<V>> bufferPersisters,
   ...
   * @param step Number of samples of delay.
   */
  public DelayMapStreamlet(final int step) {
