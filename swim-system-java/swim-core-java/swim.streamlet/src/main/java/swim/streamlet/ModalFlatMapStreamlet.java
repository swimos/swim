...
/**
 * {@link Streamlet} that, for each values of its input, emits a sequence of output values on a configured period. The
 ...
 */
public class ModalFlatMapStreamlet<In, Out, Mode> extends AbstractJunction<Out> implements Junction3<In, Duration, Mode, Out> {
   ...
   */
  public ModalFlatMapStreamlet(final Mode initMode,
   ...
   * @param delay    Period between outputs.
   */
  public ModalFlatMapStreamlet(final ValuePersister<Mode> modePersister,
                               final Function<Mode, Function<In, Iterable<Out>>> switcher,
                               final Schedule schedule,
                               final Duration delay) {
    this(modePersister,
