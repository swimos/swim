...
/**
 * Streamlet that emits its outputs on a timer rather than on receipt of input. The period of the timer can be
 * controlled by an auxiliary input.
 *
 * @param <T> The type of the data.
 */
public class VariablePeriodicStreamlet<T> extends AbstractJunction2<T, Duration, T> {
   ...
   */
  public VariablePeriodicStreamlet(final Schedule schedule,
