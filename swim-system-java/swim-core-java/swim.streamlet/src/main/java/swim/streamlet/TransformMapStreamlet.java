...
/**
 * {@link MapStreamlet} that transforms the map values with a function that depends on both the key and input value.
 *
 * @param <K>    The type of the keys.
 * @param <VIn>  The type of the input values.
 * @param <VOut> The type of the output values.
 */
public class TransformMapStreamlet<K, VIn, VOut> extends AbstractMapJunction<K, VOut> implements MapStreamlet<K, K, VIn, VOut> {
   ...
   */
  public TransformMapStreamlet(final BiFunction<K, VIn, ? extends VOut> f) {
    this.f = f;
  }
