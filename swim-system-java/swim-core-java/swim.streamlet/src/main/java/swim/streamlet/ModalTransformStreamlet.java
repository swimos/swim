...
/**
 * Streamlet that transforms its inputs using a function that can be modified by an auxiliary control input.
 *
 * @param <In>   The input type.
 * @param <Out>  The output type.
 * @param <Mode> The type of the control values.
 */
public class ModalTransformStreamlet<In, Out, Mode> extends ModalStreamlet<In, Out, Mode, Function<In, ? extends Out>> {
   ...
   */
  public ModalTransformStreamlet(final Mode init, final Function<Mode, Function<In, ? extends Out>> switcher) {
   ...
   * @param switcher Alters the transform based on the mode.
   */
  public ModalTransformStreamlet(final ValuePersister<Mode> modePersister,
