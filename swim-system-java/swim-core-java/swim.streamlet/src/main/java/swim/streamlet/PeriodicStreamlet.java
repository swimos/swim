...
/**
 * Streamlet that emits its outputs on a timer rather than on receipt of input.
 *
 * @param <T> The type of the data.
 */
public class PeriodicStreamlet<T> extends AbstractJunction<T> implements Receptacle<T> {
   ...
   */
  public PeriodicStreamlet(final Schedule schedule,
