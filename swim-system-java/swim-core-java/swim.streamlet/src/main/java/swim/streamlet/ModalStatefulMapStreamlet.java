...
/**
 * Map streamlet that maintains an external state where the function that updates the state can be modified by an
 ...
 */
public class ModalStatefulMapStreamlet<Key, ValIn, Mode, State>
    extends ModalMapStreamlet<Key, Key, ValIn, State, Mode, BiFunction<State, ValIn, State>> {
   ...
   */
  public ModalStatefulMapStreamlet(final ValuePersister<Mode> modePersister,
