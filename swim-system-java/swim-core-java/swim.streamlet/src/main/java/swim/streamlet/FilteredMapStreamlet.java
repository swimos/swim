...
/**
 * {@link MapStreamlet} that filters out some key/value pairs from it's input.
 *
 * @param <K> The type of the keys.
 * @param <V> The type of the values.
 */
public class FilteredMapStreamlet<K, V> extends AbstractMapJunction<K, V> implements MapStreamlet<K, K, V, V> {
   ...
   */
  public FilteredMapStreamlet(final BiPredicate<K, V> predicate) {
