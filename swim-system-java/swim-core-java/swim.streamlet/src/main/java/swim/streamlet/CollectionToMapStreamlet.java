...
/**
 * Streamlet that consumes collections and emits them as key/value pairs from a {@link MapJunction}.
 *
 ...
 */
public class CollectionToMapStreamlet<T, C extends Collection<T>, K, V> extends AbstractMapJunction<K, V> implements ValueToMapStreamlet<C, K, V> {
   ...
   */
  public CollectionToMapStreamlet(final Function<T, K> toKey, final Function<T, V> toValue,
