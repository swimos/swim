...
/**
 * {@link Streamlet} that, for each values of its input, emits a sequence of output values on a configured period.
 *
 * @param <In>  The type of the inputs.
 * @param <Out> The type of the outputs.
 */
public class FlatMapStreamlet<In, Out> extends AbstractJunction<Out> implements Streamlet<In, Out> {
   ...
   */
  public FlatMapStreamlet(final Function<In, Iterable<Out>> flatMapFun,
