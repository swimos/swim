...
/**
 * {@link Streamlet} that selects values from a {@link MapJunction} according to a variable key.
 *
 * @param <K> The type of the keys.
 * @param <V> The type of the values.
 */
public class ModalKeyFetchStreamlet<K, V> extends AbstractJunction<V> {
  ...
  public ModalKeyFetchStreamlet(final ValuePersister<K> keyPersister) {
    this.keyPersister = keyPersister;
    this.keyReceptcale = value -> this.keyPersister.set(value.get());
  }

  public ModalKeyFetchStreamlet() {
