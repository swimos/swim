...
/**
 * Filtered streamlet where the behaviour of the filtering is controlled by an auxiliary input.
 *
 * @param <T>    The type of the data.
 * @param <Mode> The type of the auxiliary control values.
 */
public class ModalFilteredStreamlet<T, Mode> extends ModalStreamlet<T, T, Mode, Predicate<T>> {
   ...
   */
  public ModalFilteredStreamlet(final Mode init, final Function<Mode, Predicate<T>> switcher) {
   ...
   * @param switcher      Switches the predicate according to the mode.
   */
  public ModalFilteredStreamlet(final ValuePersister<Mode> modePersister, final Function<Mode, Predicate<T>> switcher) {
