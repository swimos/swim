...
/**
 * Map streamlet that emits its outputs on a timer rather than on receipt of input. When the output triggers the entire
 ...
 */
public class SamplingMapStreamlet<K, V> extends AbstractMapJunction<K, V> implements MapJunction2<K, K, V, V, Duration> {
   ...
   */
  public SamplingMapStreamlet(final Schedule schedule,
