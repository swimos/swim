...
public class WindowStreamletSpec {
  ...
  public void timestampsFromData() {
    ...
    final WindowStreamlet<Pair<Long, Integer>, Integer, Integer> streamlet = new WindowStreamlet<>(
    ...
    streamlet.subscribe(n -> outputs.add(n.get()));
    ...
    streamlet.notifyChange(Deferred.value(input1));
    ...
    streamlet.notifyChange(Deferred.value(input2));
    ...
    streamlet.notifyChange(Deferred.value(input3));
