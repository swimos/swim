...
public class KeyedWindowStreamlet<K, V, W, U> extends AbstractMapJunction<K, U> implements MapStreamlet<K, K, V, U> {
   ...
   */
  public KeyedWindowStreamlet(final Schedule schedule,
