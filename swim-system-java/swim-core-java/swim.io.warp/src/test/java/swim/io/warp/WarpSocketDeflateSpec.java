...
public class WarpSocketDeflateSpec extends WarpSocketBehaviors {

  final Uri wsUri = Uri.parse("ws://127.0.0.1:23556/");

  public WarpSocketDeflateSpec() {
    super(WarpSettings.standard().wsSettings(WsSettings.defaultCompression()));
  }
